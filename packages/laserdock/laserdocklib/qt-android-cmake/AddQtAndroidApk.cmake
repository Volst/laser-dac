...
macro(add_qt_android_apk TARGET SOURCE_TARGET)
    ...
    cmake_parse_arguments(ARG "INSTALL" "NAME;JAVA_SOURCES;VERSION_CODE;PACKAGE_NAME;PACKAGE_SOURCES;KEYSTORE_PASSWORD" "DEPENDS;KEYSTORE" ${ARGN})
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E copy_directory ${ARG_JAVA_SOURCES} ${CMAKE_BINARY_DIR}/src
